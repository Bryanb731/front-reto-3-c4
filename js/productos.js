...
function cargarProductos() {
  ...
  $.ajax({
    ...
    url: "http://129.151.118.40:81/api/chocolate/all",
    type: "GET",
    dataType: "json",
...
function crearProducto(producto) {
  ...
  if (validarProducto(producto)) {
    $.ajax({
      ...
      url: "http://129.151.118.40:81/api/chocolate/new",
      type: "POST",
      data: dataToSend,
      datatype: "JSON",
...
function eliminarProducto(reference){
    ...
    if(opc){
        $.ajax({
            ...
            url: "http://129.151.118.40:81/api/chocolate/" + producto.reference,
            type: "DELETE",
            datatype: "JSON",
            contentType: "application/json",
            success: function (producto) {
...
function actualizarProducto(producto){
  ...
  $.ajax({
    ...
    url: "http://129.151.118.40:81/api/chocolate/update",
    type: "PUT",
    data: dataToSend,
    datatype: "JSON",
    contentType: "application/json",
