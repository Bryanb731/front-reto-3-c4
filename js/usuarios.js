...
function cargarUsuarios() {
  $.ajax({
    //url: "/api/user/all",
    url: "http://129.151.118.40:81/api/user/all",
    type: "GET",
    datatype: "JSON",
...
function crearUsuario(usuario) {
  ...
  if (validar() == true && validaContraseña() == true && correoValido) {
    $.ajax({
      //url: "/api/user/new",
      url: "http://129.151.118.40:81/api/user/new",
      type: "POST",
      data: dataToSend,
      datatype: "JSON",
      contentType: "application/json",
...
function validarExisteEmail(email, crear,actualizar=false) {
  ...
  $.ajax({
    ...
    url: "http://129.151.118.40:81/api/user/emailexist/"+email,
    type: "GET",
    dataType: "json",
...
function actualizarUsuario(usuario){
  ...
  if (validar() == true && validaContraseña() == true) {
    $.ajax({
      //url: "/api/user/update",
      url: "http://129.151.118.40:81/api/user/update",
      type: "PUT",
      data: dataToSend,
      datatype: "JSON",
      contentType: "application/json",
...
function eliminarUsuario(id) {
  ...
  if (opc) {
    $.ajax({
      ...
      url: "http://129.151.118.40:81/api/user/"+ usuario.id,
      type: "DELETE",
      dataType: "json",
      contentType: "application/json",
      success: function () {
